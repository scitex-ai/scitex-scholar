...
if __name__ == "__main__":
    ...
    async def main():
        ...
        logger.info(f"Testing ScinapseTranslator with URL: {test_url}")
        logger.info(f"URL matches pattern: {ScinapseTranslator.matches_url(test_url)}\n")
        ...
        async with async_playwright() as p:
            ...
            try:
                logger.info("Navigating to Scinapse page...")
                ...
                await capture_debug_artifacts_async(page, label="demo_scinapse_error")
                raise
            finally:
                await browser.close()
