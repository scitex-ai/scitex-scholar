...
# (project=scitex-scholar, owner=ywatanabe1989, repo=scitex-scholar,
...
TMPDIR="/tmp/publish-scitex_scholar-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-scholar dist/* uploaded to PyPI via manual OIDC trusted publishing"
