"""Smoke import mirror for scitex_scholar._utils.text._TextNormalizer.
...
def test_import__TextNormalizer_module_loads_via_importorskip():
    ...
    """
    # Arrange
    name = "scitex_scholar._utils.text._TextNormalizer"
    # Act
