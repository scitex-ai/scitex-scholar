"""Smoke import mirror for scitex_scholar._utils.validation.DOIValidator.
...
def test_import_DOIValidator_module_loads_via_importorskip():
    ...
    """
    # Arrange
    name = "scitex_scholar._utils.validation.DOIValidator"
    # Act
